...
export class Aufgabe3Component implements OnInit {
  ...
  */
  ...
  /*
  Soll true zurückliefern wenn die Eingabe eine einge gerade Zahl ist (return true), ansonsten false (return false)
  */
  isEven() {
    const number = Number(this.value);
  }
  /*  
  Soll true zurückliefern wenn die Eingabe eine einge ungerade Zahl ist (return true), ansonsten false (return false)
  */
  isOdd() {
    const number = Number(this.value);
  }
